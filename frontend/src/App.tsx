...
import { Activity, Brain, CalendarDays, CircleGauge, Command, Cpu, Home, Library, ListTodo, Menu, MessageSquare, Network, Search, Settings, UserRoundCog, Zap } from 'lucide-react'
