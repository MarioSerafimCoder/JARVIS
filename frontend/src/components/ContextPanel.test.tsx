...
describe('ContextPanel', () => {
  ...
  it('recolhe uma seção sem perder as demais', () => {
    render(<ContextPanel close={() => undefined} context={{ memories: [{ id:'m',content:'Prefere respostas breves',category:'preference',importance:4,source_type:'manual',created_at:'',updated_at:'' }] }}/>)
